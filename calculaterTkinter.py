...
#==============================================Button============================================================
btnClear = Button(calc, text=chr(67), width=6, height=2,font=('arial',20,'bold'),bd=4,bg='powder blue',command=added_value.all_Clear_Entry).grid(row=1 ,column=0,pady=1)
btnClearEntry = Button(calc, text=chr(67)+chr(69), width=6, height=2,font=('arial',20,'bold'),bd=4,bg='powder blue',command=added_value.Clear_Entry).grid(row=1 ,column=1,pady=1)
...
btnMulti = Button(calc, text="x", width=6, height=2,font=('arial',20,'bold'),bd=4,bg='powder blue',command = lambda:added_value.operation("multi")).grid(row=3 ,column=3,pady=1)
btndivide = Button(calc, text="÷", width=6, height=2,font=('arial',20,'bold'),bd=4,bg='powder blue',command = lambda:added_value.operation("divide")).grid(row=4 ,column=3,pady=1)
...
btnDot = Button(calc, text=".", width=6, height=2,font=('arial',20,'bold'),bd=4,bg='powder blue',command = lambda:added_value.operation(".")).grid(row=5 ,column=1,pady=1)
...
btnCos = Button(calc, text="log1p", width=6, height=2,font=('arial',20,'bold'),bd=4,bg='powder blue',command=added_value.log1p).grid(row=5 ,column=5,pady=1)
btnexpml = Button(calc, text="expml", width=6, height=2,font=('arial',20,'bold'),bd=4,bg='powder blue',command=added_value.expm1).grid(row=5 ,column=6,pady=1)
...
def Scientific():
    root.resizable(width=False, height=False)
    root.geometry("946x568+0+0")

def Standard():
    root.resizable(width=False, height=False)
    root.geometry("482x568+0+0")
...
filemenu.add_command(label = "Finance",command=Scientific)
